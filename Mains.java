...
public class Mains {
    public static void main(String[] args) {
       ...
       List<Product> p = service.getProduct("Logi Mouse");
       System.out.println(p);
        ...
        List<Product> places = service.getProductWithPlace("black table");
        for(Product product : places){
            System.out.println(product);
        }
        System.out.println("==============================================");
        System.out.println("the products with warranty 2023 or more than that");

        List<Product> pw = service.checkWarranty(2023);
        for(Product product : pw){
            System.out.println(product);
        }
